...
@endphp
<div class=" col-sm-12">
	<form action="{{route('contact.list')}}" method="get" accept-charset="utf-8" class="form-inline col-sm-10">
...
<table class="table table-hover">
	...
	@foreach ($contacts as $element)
		<tr>
			...
			<td>
				<a href="{{route('contact.remove',['id' => $element->id])}}" class="btn btn-xs btn-info" title="">Remove</a>
			</td>
		</tr>
	@endforeach
		<tr>
